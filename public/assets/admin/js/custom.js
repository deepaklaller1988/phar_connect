...
$(function () {
    ...
    var url = $('.subcategory-table').data('url');
    ...
    $('#createNewSubCategory').click(function () {
        ...
        $('#admincategory').append('<option>Choose Category</option>');
        $.ajax({
            type: "get",
            url: caturl,
            success: function (data) {
                data.forEach(function(item){
                    $('#admincategory').append('<option value="'+item.id+'">'+item.title+'</option>');
                });
            }
        });
        $('#saveBtn').val("create-product");
    ...
    $('#subCatsaveBtn').click(function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '#editSubCategory', function () {
        ...
        var caturl = $(this).data('caturl');
        var url = $(this).data('url');
        $.get(url,function (cdata) {
            $('#modelHeading').html("Edit Product");
            $('#saveBtn').val("edit-category");
            $('#SubcategoryModel').modal('show');
            $('#subcategory_id').val(cdata.id);
            $('#name').val(cdata.title);
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function(index, value) {
                        ...
                        if (value.id == cdata.category_id) {
                            $option.attr('selected', true);
                        }
                        $('#admincategory').append($option);
                    });
                }
            });
        })
