                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="common_input mb_15">
                                            ...
                                            <select class="form-select" id="experience_level" name="experience_level">
                                                ...
                                                <option value="1" {{ $post->experience_level == 1 ? 'selected' : ''}}>No
                                                    Experience</option>
                                                <option value="2" {{ $post->experience_level == 2 ? 'selected' : ''}}>
                                                    Entry Level
                                                </option>
                                                <option value="3" {{ $post->experience_level == 3 ? 'selected' : ''}}>
                                                    Mid Level
                                                </option>
                                                <option value="4" {{ $post->experience_level == 4 ? 'selected' : ''}}>
                                                    Senior Level
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="common_input mb_15">
                                            ...
                                            <select class="form-select" id="education_level" name="education_level">
                                                ...
                                                <option value="1" {{ $post->education_level == 1 ? 'selected' : ''}}>
                                                    High School
                                                    or Equivalent</option>
                                                <option value="2" {{ $post->education_level == 2 ? 'selected' : ''}}>
                                                    Associate
                                                    Degree</option>
                                                <option value="3" {{ $post->education_level == 3 ? 'selected' : ''}}>
                                                    Bachelor
                                                    Degree</option>
                                                <option value="4" {{ $post->education_level == 4 ? 'selected' : ''}}>
                                                    Master Degree
                                                    / MBA</option>
                                                <option value="5" {{ $post->education_level == 5 ? 'selected' : ''}}>
                                                    Doctorate
                                                    Degree/PHD/MD</option>
                                                <option value="6" {{ $post->education_level == 6 ? 'selected' : ''}}>
                                                    Other
                                                </option>
                                            </select>
