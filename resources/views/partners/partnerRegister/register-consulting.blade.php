    ...
    <div class="flexSet">
            ...
            <div class="row mb-3">
                <label for="certifications"
                    class="col-md-4 col-form-label text-md-end">{{ __('Certifications') }}<span
                        class="text-danger">*</span></label>
                <div class="col-md-6">
            ...
            <div class="row mb-3 subCategories" id="subcategory_div">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input @error('category_ids') is-invalid @enderror" id="subcategory_{{ $subcategory['id'] }}"
