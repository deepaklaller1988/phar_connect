                                ...
                                <div class="col-12">
                                    <div class="common_input mb_15">
                                        ...
                                        <div class="pictureAdmin"><span><input type="file"
                                                ...
                                                src="{{ auth()->user()->logo ? asset('storage/' .auth()->user()->logo) : asset('assets/images/consultBanner.jpg')}} " alt="profile banner" /></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="common_input mb_15">
                                        ...
                                        <div class="bannerAdmin"><span><input type="file" name="banner"><b>Upload
                                            ...
                                            </span><img src="{{ auth()->user()->banner ? asset('storage/' .auth()->user()->banner) : asset('assets/images/consultBanner.jpg')}}" alt="profile banner" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="common_input mb_15">
                                        ...
                                        <textarea name="company_profile"
                                            class="form-control">{{ auth()->user()->company_profile }}</textarea>
...
if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                $.getJSON('https://nominatim.openstreetmap.org/reverse', {
                    ...
                    if (!city) {
                        city = data.address.town || data.address.village || data.address.hamlet || data.address.suburb || data.address.state;
                    }
                   $('#location').val(city)
                }).fail(function() {
